...
Los diagramas de procesos AS-IS y TO-BE están disponibles en los documentos de presentación.
...
| Nombre | Rol |
|--------|-----|
| [Nombre 1] | [Rol en el proyecto] |
| [Nombre 2] | [Rol en el proyecto] |
| [Nombre 3] | [Rol en el proyecto] |
...
Este proyecto es de uso académico para la Universidad Pontificia Bolivariana.
...
- **GitHub:** https://github.com/juanespaez/TransCarga---DataOffice
